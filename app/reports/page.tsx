...
import { orders, sewingLines, weeklyOutput, lineEfficiency } from "@/lib/data"
import {
      ...
      <PageContainer>
        ...
        <div className="grid lg:grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie data={buyerData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={80} label={({ name, percent }) => `${(percent * 100).toFixed(0)}%`} labelLine>
